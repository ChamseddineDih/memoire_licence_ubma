...
class group_dbaccess
{
    public static function add($new_group)
    {
        ...
        try {
            ...
            $stmt->bindParam(':trs', $new_group->training_sessions);
    ...
    public static function modify($modifaited_group)
    {
        ...
        try {
            ...
            $stmt->bindParam(':trs', $modifaited_group->training_session);
